...
namespace PROG7312_MunicipalServiceApp
{
    public static class SeedData
    {
        ...
        private static void SeedServiceRequests()
        {
            ...
            {
                new ServiceRequest { Id = 1001, Title = "Burst Water Pipe", Description = "Major leak on Main Rd.", Location = "Sea Point", Status = "In Progress", Urgency = 1, DateSubmitted = DateTime.Now.AddDays(-2), ImageUrl = "/images/burst-water-pipe-2.jpg" },
                ...
                new ServiceRequest { Id = 1007, Title = "Traffic Signal Failure", Description = "Intersection lights out.", Location = "Observatory", Status = "In Progress", Urgency = 1, DateSubmitted = DateTime.Now, ImageUrl = "/images/traffic-signal.png" },
                ...
                new ServiceRequest { Id = 1009, Title = "Water Supply Disruption", Description = "No water in block B.", Location = "Gardens", Status = "In Progress", Urgency = 1, DateSubmitted = DateTime.Now, ImageUrl = "/images/no-water.png" },
                ...
                new ServiceRequest { Id = 1013, Title = "Uncollected Refuse", Description = "Bin collection missed.", Location = "Vredehoek", Status = "Resolved", Urgency = 3, DateSubmitted = DateTime.Now.AddDays(-8), ImageUrl = "/images/refuse.png" },
